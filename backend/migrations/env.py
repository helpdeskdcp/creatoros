...
def _render_item(type_, obj, autogen_context):
    """Custom types (GUID) need an explicit import line in the generated
    migration file, or the script would reference `app.db.types.GUID()`
    without ever importing `app`."""
